...
(() => {
  ...
  const L = {
    ru: {
      ...
      catalog: 'Мои фичи ✨', catalogHint: 'Выбери, что показывать в окне. Выключенные фичи прячутся, но продолжают работать в фоне.',
      tldr: 'Перескажи страницу', tldrGo: '📄 Перескажи эту страницу',
    ...
    en: {
      ...
      catalog: 'My features ✨', catalogHint: 'Pick what shows in the window. Disabled features are hidden but keep working in the background.',
      tldr: 'Summarize page', tldrGo: '📄 Summarize this page',
